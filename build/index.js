...
server.tool("list_documents", "List all available stored documents", {}, async () => {
    try {
...
server.tool("read_document", "Read content from a stored document", {
...
server.tool("search_documents", "Search for text within all stored documents", {
...
server.tool("list_agent_actions", "List all available agent.actions methods with their descriptions", {}, async () => {
    try {
...
server.tool("list_agent_utils", "List all available agent.utils methods with their descriptions", {}, async () => {
    try {
...
server.tool("get_types", "Get all TypeScript type definitions for the Xgodo Automation API", {}, async () => {
    try {
...
server.tool("get_time", "Get the current server time", {}, async () => {
    return {
        content: [
            {
                type: "text",
